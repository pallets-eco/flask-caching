...
class TestCustomKeyGeneration(CacheTestCase):
    def setUp(self):
        ...
        class Test:
            ...
            @self.cache.memoize(10**6, exclude_params=["notUsedParam"])
            def method(self, param, notUsedParam):
                return notUsedParam

            @self.cache.memoize(10**6)
...
class TestMemoizeProperty(CacheTestCase):

    def setUp(self):
        super(TestMemoizeProperty, self).setUp()
